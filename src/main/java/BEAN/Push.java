...
public class Push implements Serializable {
    ...
    @PersistenceContext(unitName = "PushPU")
    ...
    public String updateTransaction() {
        try {
            ...
            getUtx().commit();
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Success!", getTransactions().getAmount() + " Updated successfully."));
            setTransactions(new Transactions());
        } catch (IllegalStateException | SecurityException | HeuristicMixedException | HeuristicRollbackException | NotSupportedException | RollbackException | SystemException ex) {
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error!", "Could not update a user."));
        }
